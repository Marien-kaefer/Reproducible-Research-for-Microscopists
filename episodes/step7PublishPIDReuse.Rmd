...
***An identifier*** is any label used to name an item (whether digital or physical). URLs and serial numbers are an examples of digital identifiers. Personal names are also identifiers, but are not necessarily unique as you may share the same name with other researchers around the world. Even publications might share the same title. 

Examples of identifiers:

URL: https://cci.liv.ac.uk/ would direct to the correct website.... until the facility gets renamed during a restructure.
...
A DOI looks like this: https://doi.org/10.3389/fimmu.2024.1440324
...
The University of [Liverpool’s Research Data Catalogue](https://www.liverpool.ac.uk/library/research-data-management/details-guidance-advice/sharing/doi/), creates a DOI when you upload your data files. You can use this DOI in data statements, articles and other publications that are based on this data and in other digital communications, such as social media.
...
An ORCID looks like https://orcid.org/0000-0003-0118-5898.
